...
// distance between two points. Deliberately straight-line (haversine), not
// a real driving distance from the Directions API (lib/directions.ts) --
// this needs to update instantly as someone types/picks an address on the
// post form, before a post (and any Directions call, which only happens
// once a post already exists -- see post-map-section.tsx) exists at all.
